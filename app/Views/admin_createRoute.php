								...
								<div class="x_panel" style="border-color: #333;">
									...
									<div class="x_content">
										...
										<form id="createRouteForm" action="<?php echo App::url('dashboard/createRoute'); ?>" method="post" data-parsley-validate class="form-horizontal form-label-left">
											...
											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nameGR">Name in Greek<span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" id="nameGR" name="nameGR" placeholder="Προς Γλυφάδα.." required="required" class="form-control col-md-7 col-xs-12">
												</div>
											</div>
											<div class="form-group">
